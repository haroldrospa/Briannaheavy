...
export const DEFAULT_ROLE_PERMISSIONS: RolePermissionsMap = {
  Administrador: {
    ...
    'Notas de Crédito': { ver: true, crear: true, editar: true, eliminar: true },
  ...
  Oficina: {
    ...
    'Notas de Crédito': { ver: true, crear: true, editar: true, eliminar: false },
    Inventario: { ver: true, crear: false, editar: false, eliminar: false },
    Catálogo: { ver: true, crear: false, editar: false, eliminar: false },
    Herramientas: { ver: true, crear: true, editar: true, eliminar: false },
