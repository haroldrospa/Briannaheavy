      ...
      <div className="w-full max-w-none p-6 sm:p-10 font-sans flex-1 flex flex-col print:max-w-none print:p-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-white dark:bg-[#1a1a1a] p-6 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-800 space-y-6 print:shadow-none print:border-gray-900 print:rounded-none">
              ...
              <div className="space-y-3">
                ...
                <div className="flex bg-[#f4f3f1] dark:bg-[#222222] p-1 rounded-xl print:bg-transparent print:border print:border-gray-900 print:rounded-none">
                  <label className="flex-1 relative">
                    <input type="radio" name="maint_type" className="peer sr-only" defaultChecked />
                    <div className="text-center py-2 text-sm font-bold text-gray-500 dark:text-gray-400 peer-checked:text-gray-900 dark:peer-checked:text-white peer-checked:bg-white dark:peer-checked:bg-[#333333] peer-checked:shadow-sm rounded-lg transition-all cursor-pointer print:peer-checked:bg-transparent print:peer-checked:shadow-none">
                      Interno
                    </div>
                  </label>
                  <label className="flex-1 relative">
          ...
          <div className="lg:col-span-2 flex flex-col gap-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 print:gap-8">
              <div className="bg-white dark:bg-[#1a1a1a] p-6 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-800 print:shadow-none print:border-gray-900 print:rounded-none">
                <h4 className="text-sm font-bold text-gray-500 mb-12">Verificado y Liberado por</h4>
                <div className="space-y-4">
                  <div className="border-b-2 border-dashed border-gray-300 dark:border-gray-700 print:border-solid print:border-gray-900"></div>
